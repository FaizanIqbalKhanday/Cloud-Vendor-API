...
class CloudVendorAPIControllerTest {
    ...
    void setUp() {
        cloudVendorOne=new CloudVendor
                ("1","Amazon","kashmir","9906662364");
        cloudVendorTwo =new CloudVendor
                ("2","Amazon","Pulwama","98491093354");
    ...
    void TestGetCloudVendorDetails() throws Exception {
        when(cloudVendorService.geCloudVendor("1")).thenReturn(cloudVendorOne);
    ...
    @Test
    void tesrGetAllCloudVendorDetails() throws Exception {
    ...
    void testCreateCloudVendorDetails()  throws Exception{
        ...
        this.mockMvc.perform(post("/cloudvendor").contentType(MediaType.APPLICATION_JSON).content
                (requestJson)).andDo(print()).andExpect(status().isOk());
    }
    ...
    void testUpdateCloudVendorDetails() throws Exception{
        ...
        this.mockMvc.perform(put("/cloudvendor").contentType(MediaType.APPLICATION_JSON).content
                (requestJson)).andDo(print()).andExpect(status().isOk());
